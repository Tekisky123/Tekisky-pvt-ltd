...
const SingleApplicationPage = () => {
  ...
  const downloadPDF = () => {
    ...
    pdf.text("Education", 10, (pdf as any).autoTable.previous.finalY + 10);
    pdf.autoTable({
      startY: (pdf as any).autoTable.previous.finalY + 15,
      head: [["Field", "Details"]],
      body: [
    ...
    pdf.text("Skills", 10, (pdf as any).autoTable.previous.finalY + 10);
    pdf.autoTable({
      startY: (pdf as any).autoTable.previous.finalY + 15,
      head: [["Skills"]],
      body: application.skills.map((skillString) => [
        skillString
          .split(",")
    ...
    pdf.text(
      ...
      10,
      (pdf as any).autoTable.previous.finalY + 10,
    );
    pdf.autoTable({
      startY: (pdf as any).autoTable.previous.finalY + 15,
      head: [["Field", "Details"]],
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-gradient-to-r from-blue-100 to-purple-100 p-4">
      <div className="mt-20 w-full max-w-4xl rounded-lg bg-white p-6 shadow-lg">
        ...
        {/* Resume */}
        <div className="mt-10">
          <h2 className="mb-2 text-xl font-semibold text-gray-700">Resume</h2>
